...
public:
    ...
    bool operator< (MyBigNumber &other){
        if(is_minus == other.is_minus){
            ...
            if(size_this == size_other){
                ...
                std::string other_string = other.get_real_number();
    ...
    MyBigNumber operator+ (MyBigNumber other){
        ...
        if(is_minus == other.get_is_minus()){
            return MyBigNumber(add_string(real_number, other.get_real_number()), is_minus, true);
        } else {
            MyBigNumber abs_this(real_number), abs_other(other.get_real_number());
            std::string abs_str;
            bool pm;
            if(abs_this > abs_other){
                abs_str = sub_string(real_number, other.get_real_number());
                pm = is_minus;
            } else {
                abs_str = sub_string(other.get_real_number(), real_number);
    ...
    void operator= (MyBigNumber &other){
        is_minus = other.get_is_minus();
        is_inversed = other.get_is_inversed();
        real_number = other.get_real_number();
    }
